...
require_once ('C:/xampp/htdocs/jpgraph-4.3.4/jpgraph-4.3.4/src/jpgraph_bar.php');
...
// Setup the titles
$graph->title->Set('CO Achieved by each PLO');
$graph->xaxis->title->Set('PLOs');
$graph->yaxis->title->Set('Number of Achieved CO');
